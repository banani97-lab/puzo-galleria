...
export type ProductVideoQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type ProductVideoQuery = {
  node?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Video, 'alt' | 'id'> & {
      sources: Array<
        {__typename: 'VideoSource'} & Pick<
          StorefrontAPI.VideoSource,
          'width' | 'height' | 'mimeType' | 'format' | 'url'
        >
      >;
      ...
      previewImage?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Image, 'altText' | 'height' | 'width' | 'id' | 'url'>
      >;
    }
  >;
};
...
interface GeneratedQueryTypes {
  ...
  '#graphql\nquery ProductVideo {\n  node(id:"gid://shopify/Video/64729619333465") {\n    ... on Video {\n      alt\n      id\n      sources {\n        width\n        height\n        mimeType\n        format\n        url\n        __typename\n      }\n      presentation {\n        id\n      }\n      previewImage {\n        altText\n        height\n        width\n        id\n        url\n      }\n    }\n  }\n}\n': {
    ...
    variables: ProductVideoQueryVariables;
  };
